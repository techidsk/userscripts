...
| [IT之家移动端阅读增强](scripts/ithome-reader/) | 为移动端新闻流和热榜补充导语，提供左右卡片布局以及图片、紧凑和净化开关 | [安装脚本](https://raw.githubusercontent.com/techidsk/userscripts/main/scripts/ithome-reader/ithome-reader.user.js) |
